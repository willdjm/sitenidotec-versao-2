  ...
  return (
    <section className="py-10 bg-white">
      <div className="flex flex-col px-4 mx-auto max-w-7xl xl:px-0">
        ...
        {/* Mobile Version - Imagens escondidas */}
        <div className="lg:hidden w-full">
          <ul className="space-y-3">
            {/* Repetir os mesmos itens, mas sem imagens visíveis no mobile */}
        ...
        <div className="flex justify-center my-16">
          <Link href="https://wa.me/5511953052059" target="_blank">
            ...
            <button className="px-6 py-2 flex items-center justify-center text-white bg-sky-500 rounded-lg shadow-lg hover:bg-sky-600 transform transition-all duration-300 ease-in-out">
            <picture>
                    <img
                      src="/logo-icone-nidoadm.png"
                      alt="App screenshot"
