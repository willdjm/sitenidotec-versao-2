...
export const SectionNIDOImovel = () => {
  return (
    <section className="mx-auto max-w-screen-xl lg:p-10 p-4">
      ...
      <div className="flex flex-col md:flex lg:flex-row lg:gap-8">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <div className="space-y-2">
                <picture>
                <img src="/logo_imovel.png" alt="" className="w-full md:w-1/2 mb-5 md:mb-0" />
                </picture>
              </div>
              <h1 className="text-3xl font-bold tracking-tight text-sky-500">
              Gestão Imobiliária            
              </h1>
              <p className="text-xl text-sky-500">O sistema mais completo do mercado imobiliário.
              O NIDOImóvel foi desenvolvido em parceria com algumas das maiores operadoras do mercado imobiliário nacional.
                            </p>
            </div>
            ...
            <div className="grid md:flex space-x-4 text-white">
              <div className='flex items-center justify-center space-x-2 mb-5 lg:mb-0'>
                <div className="flex items-center justify-center space-x-2">
                  ...
                  <span className="flex-shrink-0 text-xs font-medium leading-5 text-sky-500">+460</span>
                </div>
              ...
              >
                ...
                <div className='flex flex-col mx-6 md:mx-4'>
                  ...
                  <span className="text-base">NIDOImóvel</span>
                </div>
        ...
        <div className="flex items-center lg:col-span-6 mt-5 lg:mt-0">
          <div className="w-full h-full">
            <video className="w-full h-full rounded" controls poster="/capa-video-imovel.jpg">
